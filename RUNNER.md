...
**Proposed architecture, not an implemented runner.** This document describes how models would be compared once the task corpus and scorer are ready.
...
```sh
# Proposed commands only — no `brickbench` CLI exists in this repository yet.
